 ...
 return (
  <SafeAreaView className="flex-1 bg-gray-50" edges={["top"]}>
   <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
    {/* profile header */}
    <View className="bg-white px-4 pt-6 pb-6 items-center border-b border-gray-100">
     <View className="relative mb-3">
      {avatarUrl ? (
       ...
       <View className="w-20 h-20 rounded-full bg-indigo-100 items-center justify-center">
        <Text className="text-indigo-600 text-2xl font-bold">{initials}</Text>
       </View>
      )}
     </View>
    ...
    <View className="mx-4 mt-6 bg-white rounded-2xl overflow-hidden border border-gray-100">
     ...
     />
     <View className="h-px bg-gray-50 ml-14" />
     <MenuItem icon="shield-outline" label="Privacy" onPress={() => {}} />
     <View className="h-px bg-gray-50 ml-14" />
     <MenuItem
